...
#include "../objects/IPvXAddress.h"
#include "../transport/InterfaceTableAccess.h"
#include "Constants.h"
#include "Util.h"
...
protected:
    ...
    virtual void sendMsg(cMessage* msg, const char* link, cGate::Type linkType);
    ...
    virtual IPvXAddress loadAddress(const char* interface);

    virtual UDPControlInfo* generateControlInfo(IPvXAddress src, IPvXAddress dest);
};
